  ...
  return (
    <>
      ...
      {productsData.map((data, index) => (
        <div
          key={index}
          class="card mb-3 container mt-5"
          ...
          <div class="row no-gutters">
            <div class="col-md-4">
              {data.image ? (
                ...
                <img
                  style={imgDesign}
                  src={`http://enigmatic-brook-14059.herokuapp.com/${data?.file?.name}`}
                  class="card-img-top"
                  alt="..."
                />
              )}
            ...
            <form
              action=""
              onSubmit={() => updateProduct(data._id)}
              className="mb-2"
            >
              <input
                type="text"
                ...
                defaultValue={singleProductData.name}
                id=""
              />
              <input
                type="text"
                ...
                placeholder="price"
                onChange={handleChange}
                defaultValue={singleProductData.price}
                id=""
              />
              <input
                type="text"
                ...
                onChange={handleChange}
                className="mr-2"
                defaultValue={singleProductData.date}
                id=""
              />
